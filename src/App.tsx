    ...
    <main className="cv-page">
      <header className="hero">
        ...
        <p className="hero__contacts">
          ...
          <span>/</span>
          <a href="mailto:sitnikovdan13@gmail.com">Email: sitnikovdan13@gmail.com</a>
          <span>/</span>
      ...
      <section className="cv-section">
        <p className="lead">
          <strong>Summary:</strong> Frontend Engineer with 5 years of experience building
          product-oriented web applications, including complex admin systems and
          consumer-facing apps. Strong hands-on experience with React and
          TypeScript, designing scalable UI architectures and collaborating with
          international teams to deliver reliable, high-quality user interfaces.
        </p>
      </section>
        ...
        <div className="experience-list">
          {experience.map((item) => (
            <article className="experience-item" key={item.company}>
              ...
              <p className="experience-item__label">Responsibilities:</p>
              <ul>
      ...
      <section className="cv-section">
        ...
        <p className="lead">
          <strong>Languages:</strong> Russian (native), English (upper-intermediate)
        </p>
      </section>
    </main>
  )
